...
const closeAll = () => {
  ...
  return (
    <div>
        ...
        <Head>
				<title>Etherise | Raise funds on-chain</title>
				<meta
					name="description"
			...
			<header className="bg-white bg-opacity-95 border-b border-gray-200  z-50">
				<div
			...
			<div className={styles.header}>
                <div className='flex space-x-16 justify-center items-center'>
                    <div className='flex justify-center items-center space-x-1 text-white'><Link href="/" className='font-bold  text-2xl text-primary font-heading'>Etherise</Link></div>              
